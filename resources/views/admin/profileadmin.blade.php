...
<head>
    ...
    <style>
        ...
        @media (min-width: 601px) {
            .profile-section.fullname { left: 38vw; top: 30vh; }
            .profile-section.address { left: 38vw; top: 50vh; }
            .profile-section.city { left: 38vw; top: 70vh; }
            .profile-section.birthdate { left: 38vw; top: 90vh; }
            .profile-section.gender { left: 38vw; top: 110vh; }
            .profile-section.role { left: 38vw; top: 130vh; }
        }
...
<body>
    <div style="width: 100%; height: auto; position: relative; background: white">
        ...
        <img id="profileImage" src="{{ $user->image ? asset('storage/' . $user->image) : 'https://via.placeholder.com/389x653' }}" alt="Profile Image" />
        ...
        <div style="width: 27.5vw; left: 38.5vw; top: 160vh; position: absolute; text-align: center;">
        <a href="/editprofileadmin" style="text-decoration: none;">
        ...
        <div class="icon-text-container" style="left: 2vw; top: 150vh;">
            <img src="{{ asset('storage/a.png') }}" alt="WhatsApp Icon" class="icon">
            <div class="text">{{ $user->WA }}</div>
        </div>

        <div class="icon-text-container" style="left: 2vw; top: 160vh;">
            <img src="{{ asset('storage/b.png') }}" alt="Instagram Icon" class="icon">
            <div class="text">{{ $user->IG }}</div>
        </div>

        <div class="icon-text-container" style="left: 2vw; top: 170vh;">
            <img src="{{ asset('storage/c.png') }}" alt="Facebook Icon" class="icon">
            <div class="text">{{ $user->FB }}</div>
        </div>

        <div class="icon-text-container" style="left: 2vw; top: 180vh;">
            <img src="{{ asset('storage/d.png') }}" alt="Gmail Icon" class="icon">
            <div class="text">{{ $user->gmail }}</div>
        </div>

        <div style="width: 180px; height: 55px; left: 67vw; top: 160vh; position: absolute;">
            <button class="back-button" onclick="window.location.href='/landingpageadmin'">
