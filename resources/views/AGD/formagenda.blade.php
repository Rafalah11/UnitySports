...
<script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            var kabupatenSelect = document.getElementById('nama_kabupaten');
...
<body>  
    <section class="container">
        ...
        <form action="{{ route('formagenda') }}" method="POST" enctype="multipart/form-data" class="form needs-validation" novalidate>
            @csrf
            <div class="input-box">
                <label>Nama Komunitas</label>
                <input type="text" class="form-control" name="nama_komunitas" placeholder="Masukan nama komunitas" required />
                <div class="invalid-feedback">Nama Komunitas diperlukan.</div>
            </div>
            ...
            <div class="input-box address">
                ...
                <input type="number" class="form-control" name="level" placeholder="Masukan Level" required />
                <div class="invalid-feedback">Level diperlukan.</div>
            ...
            <label>Address</label>
                <div class="column">
                    ...
                    <div class="select-box">
                        <select name="nama_kabupaten" id="nama_kabupaten" class="form-control" required>
            ...
            <div class="column">
                <div class="input-box">
                    ...
                    <input type="number" class="form-control" name="kontak" placeholder="Masukan Nomor Telepon (contoh : +62895*****)" required />
                ...
                <div class="invalid-feedback">Waktu diperlukan.</div>
            </div>
                </div>
            ...
            <div class="row">
            <div class="col">
        <button type="button" class="btn btn-secondary w-100" onclick="window.location.href='{{ route('agenda') }}'">Cancel</button>
            </div>
            <div class="col">
